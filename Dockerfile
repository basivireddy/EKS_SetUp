...
RUN jenkins-plugin-cli --plugins "blueocean:1.25.3 docker-workflow:1.28 pipeline-utility-steps:2.12.1 git:4.11.1 sonar:2.14 artifactory:3.16.2 ssh-agent ssh-credentials ssh-slaves ws-cleanup"
